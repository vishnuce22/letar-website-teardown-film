Machine Photo Assets
====================
Drop your shop photos here. Each filename maps to a machine card on the homepage.

Expected files:
  mam72.jpg     — Matsuura MAM72-100H (5-Axis HMC with pallet pool)
  dmu60.jpg     — DMG DMU 60 EVO (5-Axis Universal)
...
The flip card back face shows a dark navy background if the image file is missing,
so the site renders cleanly even before photos are added.
